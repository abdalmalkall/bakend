        ...
        <div style={styles.container} className='mt-10 mb-20'>
            <div style={styles.card}>
                ...
                <div style={styles.innerCard}>
                    <h3 style={styles.cardTitle}>Vue JS</h3>
                    <p style={styles.cardText}>An open-source JavaScript dependency-free front end JavaScript framework for building user interface and single-page applications.</p>
